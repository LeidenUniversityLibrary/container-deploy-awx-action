...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | The generated UUID for this application.
    |
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | ULCN username for local testing
    |--------------------------------------------------------------------------
    |
    | When using this app locally, you cannot connect to ULCN's SSO. To work around that issue, we mock the existence of
    | a user.
    |
    */

    'mockUlcnUsername' => env('MOCK_ULCN_USERNAME_FOR_LOCAL_TESTING'),
